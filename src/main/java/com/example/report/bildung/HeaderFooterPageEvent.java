...
public class HeaderFooterPageEvent extends PdfPageEventHelper {
    ...
    private void addHeader(PdfWriter writer) {
        ...
        // add image
        Image logo = Image.getInstance("header.png");
        ...
        text.addElement(new Phrase("deader.com", new Font(Font.FontFamily.HELVETICA, 8)));
        header.addCell(text);
        // write content
    ...
    private void addFooter(PdfWriter writer) {
        ...
        try {
            ...
            // add copyright
            footer.addCell(new Phrase("footer.com", new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD)));
